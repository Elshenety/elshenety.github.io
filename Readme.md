...
<div align="center">
  <img src="CMUT-FP.png" alt="cmut-fp" width="600">
</div>
...
*   **Cleanroom Expertise:**
       ...
       *  **Characterization:** SEM/EDX, Zygo Optical Profilometer (Dynamic/Static), Impedance Analyzer, Semiconductor Parameter Analyzer (SPA), Bruker Dektak, Keyence VKX Microscope, Probe Station, Dicing Saw.
*   **Simulation Software:** OnScale, ANSYS (static analysis & modal analysis), MATLAB
